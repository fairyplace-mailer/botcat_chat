 ...
 *
 * ВАЖНО: В этом файле можно исправлять только очевидные противоречия
 * между текстовым описанием форматов и фактическим контрактом проекта/ТЗ.
 */
...
3) Сформировать:
   ...
   — sendToInternal                  (bool: нужно ли слать email внутренней команде FairyPlace™)
...
#### Если languageOriginal !== "ru":
— Переводим каждое сообщение пользователя и BotCat на русский.
